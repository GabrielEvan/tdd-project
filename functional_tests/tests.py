...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_for_one_user(self):
        # Maria decidiu utilizar o novo app T0DO. Ela entra em sua página principal:
        self.browser.get(self.live_server_url)

        # Ela nota que o título da página menciona T0DO
        self.assertIn('To-Do', self.browser.title)
        header_text = self.browser.find_element_by_tag_name('h1').text
        self.assertIn('To-Do', header_text)

        # Ela é convidada a entrar com um item T0DO imediatamente
        ...
        # "1: Estudar testes funcionais" como um item da lista T0DO
